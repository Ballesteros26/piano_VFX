...
namespace System.Drawing
{
	...
	internal class GDIPlus
	{
		...
		// Token: 0x0600078F RID: 1935 RVA: 0x000151AC File Offset: 0x000133AC
		...
		// Token: 0x06000790 RID: 1936 RVA: 0x000151B8 File Offset: 0x000133B8
		static GDIPlus()
		{
		...
		// Token: 0x06000791 RID: 1937 RVA: 0x000152C4 File Offset: 0x000134C4
		public static bool RunningOnWindows()
		{
			return !GDIPlus.UseX11Drawable && !GDIPlus.UseCarbonDrawable && !GDIPlus.UseCocoaDrawable;
		}

		// Token: 0x06000792 RID: 1938 RVA: 0x000152DE File Offset: 0x000134DE
		public static bool RunningOnUnix()
		{
			return GDIPlus.UseX11Drawable || GDIPlus.UseCarbonDrawable || GDIPlus.UseCocoaDrawable;
		}

		// Token: 0x06000793 RID: 1939 RVA: 0x000152F8 File Offset: 0x000134F8
		...
		// Token: 0x06000794 RID: 1940 RVA: 0x00015358 File Offset: 0x00013558
		...
		// Token: 0x06000795 RID: 1941 RVA: 0x000153B8 File Offset: 0x000135B8
		public static IntPtr FromPointToUnManagedMemoryI(Point[] pts)
		{
			...
			while (i < pts.Length)
			{
				Marshal.StructureToPtr<Point>(pts[i], intPtr2, false);
				i++;
		...
		// Token: 0x06000796 RID: 1942 RVA: 0x00015410 File Offset: 0x00013610
		...
		// Token: 0x06000797 RID: 1943 RVA: 0x00015470 File Offset: 0x00013670
		public static IntPtr FromPointToUnManagedMemory(PointF[] pts)
		{
			...
			while (i < pts.Length)
			{
				Marshal.StructureToPtr<PointF>(pts[i], intPtr2, false);
				i++;
				intPtr2 = new IntPtr(intPtr2.ToInt64() + (long)num);
			}
			return intPtr;
		...
		// Token: 0x06000798 RID: 1944 RVA: 0x000154C8 File Offset: 0x000136C8
		internal static void CheckStatus(Status status)
		{
			...
			case Status.WrongState:
				throw new ArgumentException(Locale.GetText("Object is not in a state that can allow this operation [GDI+ status: {0}]", new object[] { status }));
		...
		{
			// Token: 0x060009F4 RID: 2548 RVA: 0x00015708 File Offset: 0x00013908
			...
			// Token: 0x060009F5 RID: 2549 RVA: 0x0001575C File Offset: 0x0001395C
			...
			// (get) Token: 0x060009F6 RID: 2550 RVA: 0x000157DC File Offset: 0x000139DC
			...
			// Token: 0x060009F7 RID: 2551 RVA: 0x00015818 File Offset: 0x00013A18
			...
			// (get) Token: 0x060009F8 RID: 2552 RVA: 0x00015994 File Offset: 0x00013B94
			...
			// Token: 0x060009F9 RID: 2553 RVA: 0x000159D0 File Offset: 0x00013BD0
			...
			// (get) Token: 0x060009FA RID: 2554 RVA: 0x00015A33 File Offset: 0x00013C33
			...
			// Token: 0x060009FB RID: 2555 RVA: 0x00015A6C File Offset: 0x00013C6C
			...
			// (get) Token: 0x060009FC RID: 2556 RVA: 0x00015AA7 File Offset: 0x00013CA7
			...
			// Token: 0x060009FD RID: 2557 RVA: 0x00015AE0 File Offset: 0x00013CE0
			...
			// (get) Token: 0x060009FE RID: 2558 RVA: 0x00015AED File Offset: 0x00013CED
			...
			// Token: 0x060009FF RID: 2559 RVA: 0x00015B1C File Offset: 0x00013D1C
			...
			// (get) Token: 0x06000A00 RID: 2560 RVA: 0x00015B50 File Offset: 0x00013D50
