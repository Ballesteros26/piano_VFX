...
namespace System.Drawing.Imaging
{
	...
	{
		// Token: 0x06000C28 RID: 3112 RVA: 0x0001AE70 File Offset: 0x00019070
		~EncoderParameter()
		{
			this.Dispose(false);
		}
		...
		// (get) Token: 0x06000C29 RID: 3113 RVA: 0x0001AEA0 File Offset: 0x000190A0
		// (set) Token: 0x06000C2A RID: 3114 RVA: 0x0001AEAD File Offset: 0x000190AD
		...
		// (get) Token: 0x06000C2B RID: 3115 RVA: 0x0001AEBB File Offset: 0x000190BB
		...
		// (get) Token: 0x06000C2C RID: 3116 RVA: 0x0001AEBB File Offset: 0x000190BB
		...
		// (get) Token: 0x06000C2D RID: 3117 RVA: 0x0001AEC3 File Offset: 0x000190C3
		...
		// Token: 0x06000C2E RID: 3118 RVA: 0x0001AECB File Offset: 0x000190CB
		public void Dispose()
		{
			this.Dispose(true);
			GC.KeepAlive(this);
		...
		// Token: 0x06000C2F RID: 3119 RVA: 0x0001AEE0 File Offset: 0x000190E0
		...
		// Token: 0x06000C30 RID: 3120 RVA: 0x0001AF0C File Offset: 0x0001910C
		...
		// Token: 0x06000C31 RID: 3121 RVA: 0x0001AF80 File Offset: 0x00019180
		...
		// Token: 0x06000C32 RID: 3122 RVA: 0x0001B000 File Offset: 0x00019200
		...
		// Token: 0x06000C33 RID: 3123 RVA: 0x0001B074 File Offset: 0x00019274
		...
		// Token: 0x06000C34 RID: 3124 RVA: 0x0001B0E8 File Offset: 0x000192E8
		...
		// Token: 0x06000C35 RID: 3125 RVA: 0x0001B170 File Offset: 0x00019370
		...
		// Token: 0x06000C36 RID: 3126 RVA: 0x0001B1FC File Offset: 0x000193FC
		...
		// Token: 0x06000C37 RID: 3127 RVA: 0x0001B2B0 File Offset: 0x000194B0
		...
		// Token: 0x06000C38 RID: 3128 RVA: 0x0001B310 File Offset: 0x00019510
		public EncoderParameter(Encoder encoder, byte[] value)
		{
			this._parameterGuid = encoder.Guid;
			this._parameterValueType = EncoderParameterValueType.ValueTypeByte;
		...
		/// <param name="undefined">If true, the <see cref="P:System.Drawing.Imaging.EncoderParameter.ValueType" /> property is set to <see cref="F:System.Drawing.Imaging.EncoderParameterValueType.ValueTypeUndefined" />; otherwise, the <see cref="P:System.Drawing.Imaging.EncoderParameter.ValueType" /> property is set to <see cref="F:System.Drawing.Imaging.EncoderParameterValueType.ValueTypeByte" />. </param>
		// Token: 0x06000C39 RID: 3129 RVA: 0x0001B384 File Offset: 0x00019584
		public EncoderParameter(Encoder encoder, byte[] value, bool undefined)
		{
			this._parameterGuid = encoder.Guid;
			if (undefined)
		...
		// Token: 0x06000C3A RID: 3130 RVA: 0x0001B404 File Offset: 0x00019604
		public EncoderParameter(Encoder encoder, short[] value)
		{
			this._parameterGuid = encoder.Guid;
			this._parameterValueType = EncoderParameterValueType.ValueTypeShort;
		...
		// Token: 0x06000C3B RID: 3131 RVA: 0x0001B488 File Offset: 0x00019688
		...
		// Token: 0x06000C3C RID: 3132 RVA: 0x0001B544 File Offset: 0x00019744
		public EncoderParameter(Encoder encoder, int[] numerator, int[] denominator)
		{
			this._parameterGuid = encoder.Guid;
		...
		// Token: 0x06000C3D RID: 3133 RVA: 0x0001B60C File Offset: 0x0001980C
		public EncoderParameter(Encoder encoder, long[] rangebegin, long[] rangeend)
		{
			this._parameterGuid = encoder.Guid;
		...
		// Token: 0x06000C3E RID: 3134 RVA: 0x0001B6D4 File Offset: 0x000198D4
		...
		// Token: 0x06000C3F RID: 3135 RVA: 0x0001B7E4 File Offset: 0x000199E4
		...
		/// <param name="type">A member of the <see cref="T:System.Drawing.Imaging.EncoderParameterValueType" /> enumeration that specifies the data type of the values stored in the <see cref="T:System.Drawing.Imaging.EncoderParameter" /> object. The <see cref="T:System.Type" /> and <see cref="P:System.Drawing.Imaging.EncoderParameter.ValueType" /> properties are set to this value. </param>
		/// <param name="value">A pointer to an array of values of the type specified by the <paramref name="Type" /> parameter.</param>
		// Token: 0x06000C40 RID: 3136 RVA: 0x0001B8B8 File Offset: 0x00019AB8
		...
		// Token: 0x06000C41 RID: 3137 RVA: 0x0001B988 File Offset: 0x00019B88
		private static IntPtr Add(IntPtr a, int b)
		{
			return (IntPtr)((long)a + (long)b);
		}

		// Token: 0x06000C42 RID: 3138 RVA: 0x0001B998 File Offset: 0x00019B98
