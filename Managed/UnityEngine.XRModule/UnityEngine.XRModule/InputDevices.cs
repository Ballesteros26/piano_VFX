...
namespace UnityEngine.XR
{
	...
	{
		// Token: 0x060000B4 RID: 180 RVA: 0x00003CE8 File Offset: 0x00001EE8
		...
		// Token: 0x060000B5 RID: 181 RVA: 0x00003D08 File Offset: 0x00001F08
		...
		// Token: 0x060000B6 RID: 182 RVA: 0x00003D9C File Offset: 0x00001F9C
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x00003DCC File Offset: 0x00001FCC
		...
		// Token: 0x060000B8 RID: 184 RVA: 0x00003E70 File Offset: 0x00002070
		...
		// (add) Token: 0x060000B9 RID: 185 RVA: 0x00003F14 File Offset: 0x00002114
		// (remove) Token: 0x060000BA RID: 186 RVA: 0x00003F48 File Offset: 0x00002148
		[field: DebuggerBrowsable(0)]
		public static event Action<InputDevice> deviceConnected;

		// Token: 0x14000006 RID: 6
		// (add) Token: 0x060000BB RID: 187 RVA: 0x00003F7C File Offset: 0x0000217C
		// (remove) Token: 0x060000BC RID: 188 RVA: 0x00003FB0 File Offset: 0x000021B0
		[field: DebuggerBrowsable(0)]
		public static event Action<InputDevice> deviceDisconnected;

		// Token: 0x14000007 RID: 7
		// (add) Token: 0x060000BD RID: 189 RVA: 0x00003FE4 File Offset: 0x000021E4
		// (remove) Token: 0x060000BE RID: 190 RVA: 0x00004018 File Offset: 0x00002218
		[field: DebuggerBrowsable(0)]
		public static event Action<InputDevice> deviceConfigChanged;

		// Token: 0x060000BF RID: 191 RVA: 0x0000404C File Offset: 0x0000224C
		...
		private static void InvokeConnectionEvent(ulong deviceId, ConnectionChangeType change)
		{
			...
			case ConnectionChangeType.Connected:
			{
				...
				if (flag)
				{
					InputDevices.deviceConnected.Invoke(new InputDevice(deviceId));
				}
				break;
			}
			case ConnectionChangeType.Disconnected:
			{
				...
				if (flag2)
				{
					InputDevices.deviceDisconnected.Invoke(new InputDevice(deviceId));
				}
				break;
			}
			case ConnectionChangeType.ConfigChange:
			{
				...
				if (flag3)
				{
					InputDevices.deviceConfigChanged.Invoke(new InputDevice(deviceId));
				}
				break;
			}
			}
		...
		// Token: 0x060000DB RID: 219 RVA: 0x000040D0 File Offset: 0x000022D0
