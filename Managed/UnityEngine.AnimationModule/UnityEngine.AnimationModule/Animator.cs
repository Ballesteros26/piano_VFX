...
namespace UnityEngine
{
	...
	public class Animator : Behaviour
	{
		...
		// Token: 0x060000C8 RID: 200 RVA: 0x00002944 File Offset: 0x00000B44
		public float GetFloat(string name)
		{
			return this.GetFloatString(name);
		}

		// Token: 0x060000C9 RID: 201 RVA: 0x00002960 File Offset: 0x00000B60
		public float GetFloat(int id)
		{
			return this.GetFloatID(id);
		}

		// Token: 0x060000CA RID: 202 RVA: 0x00002979 File Offset: 0x00000B79
		public void SetFloat(string name, float value)
		{
			this.SetFloatString(name, value);
		}

		// Token: 0x060000CB RID: 203 RVA: 0x00002985 File Offset: 0x00000B85
		public void SetFloat(string name, float value, float dampTime, float deltaTime)
		{
			this.SetFloatStringDamp(name, value, dampTime, deltaTime);
		}

		// Token: 0x060000CC RID: 204 RVA: 0x00002994 File Offset: 0x00000B94
		public void SetFloat(int id, float value)
		{
			this.SetFloatID(id, value);
		}

		// Token: 0x060000CD RID: 205 RVA: 0x000029A0 File Offset: 0x00000BA0
		public void SetFloat(int id, float value, float dampTime, float deltaTime)
		{
			this.SetFloatIDDamp(id, value, dampTime, deltaTime);
		}

		// Token: 0x060000CE RID: 206 RVA: 0x000029B0 File Offset: 0x00000BB0
		public bool GetBool(string name)
		{
			return this.GetBoolString(name);
		}

		// Token: 0x060000CF RID: 207 RVA: 0x000029CC File Offset: 0x00000BCC
		public bool GetBool(int id)
		{
			return this.GetBoolID(id);
		}

		// Token: 0x060000D0 RID: 208 RVA: 0x000029E5 File Offset: 0x00000BE5
		public void SetBool(string name, bool value)
		{
			this.SetBoolString(name, value);
		}

		// Token: 0x060000D1 RID: 209 RVA: 0x000029F1 File Offset: 0x00000BF1
		public void SetBool(int id, bool value)
		{
			this.SetBoolID(id, value);
		}

		// Token: 0x060000D2 RID: 210 RVA: 0x00002A00 File Offset: 0x00000C00
		public int GetInteger(string name)
		{
			return this.GetIntegerString(name);
		}

		// Token: 0x060000D3 RID: 211 RVA: 0x00002A1C File Offset: 0x00000C1C
		public int GetInteger(int id)
		{
			return this.GetIntegerID(id);
		}

		// Token: 0x060000D4 RID: 212 RVA: 0x00002A35 File Offset: 0x00000C35
		public void SetInteger(string name, int value)
		{
			this.SetIntegerString(name, value);
		}

		// Token: 0x060000D5 RID: 213 RVA: 0x00002A41 File Offset: 0x00000C41
		public void SetInteger(int id, int value)
		{
			this.SetIntegerID(id, value);
		}

		// Token: 0x060000D6 RID: 214 RVA: 0x00002A4D File Offset: 0x00000C4D
		public void SetTrigger(string name)
		{
			this.SetTriggerString(name);
		}

		// Token: 0x060000D7 RID: 215 RVA: 0x00002A58 File Offset: 0x00000C58
		public void SetTrigger(int id)
		{
			this.SetTriggerID(id);
		}

		// Token: 0x060000D8 RID: 216 RVA: 0x00002A63 File Offset: 0x00000C63
		public void ResetTrigger(string name)
		{
			this.ResetTriggerString(name);
		}

		// Token: 0x060000D9 RID: 217 RVA: 0x00002A6E File Offset: 0x00000C6E
		public void ResetTrigger(int id)
		{
			this.ResetTriggerID(id);
		}

		// Token: 0x060000DA RID: 218 RVA: 0x00002A7C File Offset: 0x00000C7C
		public bool IsParameterControlledByCurve(string name)
		{
			return this.IsParameterControlledByCurveString(name);
		}

		// Token: 0x060000DB RID: 219 RVA: 0x00002A98 File Offset: 0x00000C98
		...
		// (get) Token: 0x060000DC RID: 220 RVA: 0x00002AB4 File Offset: 0x00000CB4
		...
		// (get) Token: 0x060000DD RID: 221 RVA: 0x00002ACC File Offset: 0x00000CCC
		...
		// (get) Token: 0x060000DE RID: 222 RVA: 0x00002AE4 File Offset: 0x00000CE4
		...
		// (get) Token: 0x060000DF RID: 223 RVA: 0x00002AFC File Offset: 0x00000CFC
		...
		// (get) Token: 0x060000E0 RID: 224 RVA: 0x00002B14 File Offset: 0x00000D14
		// (set) Token: 0x060000E1 RID: 225 RVA: 0x00002B2A File Offset: 0x00000D2A
		...
		// (get) Token: 0x060000E2 RID: 226 RVA: 0x00002B34 File Offset: 0x00000D34
		// (set) Token: 0x060000E3 RID: 227 RVA: 0x00002B4A File Offset: 0x00000D4A
		...
		// (get) Token: 0x060000E8 RID: 232 RVA: 0x00002B54 File Offset: 0x00000D54
		// (set) Token: 0x060000E9 RID: 233 RVA: 0x00002B6F File Offset: 0x00000D6F
		...
		// (get) Token: 0x060000F0 RID: 240 RVA: 0x00002B80 File Offset: 0x00000D80
		// (set) Token: 0x060000F1 RID: 241 RVA: 0x00002B9F File Offset: 0x00000D9F
		...
		// (get) Token: 0x060000F2 RID: 242 RVA: 0x00002BB4 File Offset: 0x00000DB4
		// (set) Token: 0x060000F3 RID: 243 RVA: 0x00002BCA File Offset: 0x00000DCA
		...
		// (get) Token: 0x060000F4 RID: 244 RVA: 0x00002BD4 File Offset: 0x00000DD4
		// (set) Token: 0x060000F5 RID: 245 RVA: 0x00002BF3 File Offset: 0x00000DF3
		...
		// (get) Token: 0x060000F6 RID: 246 RVA: 0x00002C08 File Offset: 0x00000E08
		// (set) Token: 0x060000F7 RID: 247 RVA: 0x00002C1E File Offset: 0x00000E1E
		...
		// Token: 0x060000F8 RID: 248 RVA: 0x00002C28 File Offset: 0x00000E28
		...
		// Token: 0x060000F9 RID: 249 RVA: 0x00002C48 File Offset: 0x00000E48
		...
		// Token: 0x060000FA RID: 250 RVA: 0x00002C5F File Offset: 0x00000E5F
		...
		// Token: 0x060000FB RID: 251 RVA: 0x00002C72 File Offset: 0x00000E72
		private void SetGoalPosition(AvatarIKGoal goal, Vector3 goalPosition)
		{
			this.SetGoalPosition_Injected(goal, ref goalPosition);
		}

		// Token: 0x060000FC RID: 252 RVA: 0x00002C80 File Offset: 0x00000E80
		...
		// Token: 0x060000FD RID: 253 RVA: 0x00002CA0 File Offset: 0x00000EA0
		...
		// Token: 0x060000FE RID: 254 RVA: 0x00002CB7 File Offset: 0x00000EB7
		...
		// Token: 0x060000FF RID: 255 RVA: 0x00002CCA File Offset: 0x00000ECA
		...
		// Token: 0x06000100 RID: 256 RVA: 0x00002CD8 File Offset: 0x00000ED8
		...
		// Token: 0x06000102 RID: 258 RVA: 0x00002CF8 File Offset: 0x00000EF8
		...
		// Token: 0x06000104 RID: 260 RVA: 0x00002D0C File Offset: 0x00000F0C
		...
		// Token: 0x06000106 RID: 262 RVA: 0x00002D2C File Offset: 0x00000F2C
		...
		// Token: 0x06000108 RID: 264 RVA: 0x00002D40 File Offset: 0x00000F40
		...
		// Token: 0x0600010A RID: 266 RVA: 0x00002D77 File Offset: 0x00000F77
		...
		// Token: 0x0600010B RID: 267 RVA: 0x00002D8A File Offset: 0x00000F8A
		private void SetHintPosition(AvatarIKHint hint, Vector3 hintPosition)
		{
			this.SetHintPosition_Injected(hint, ref hintPosition);
		}

		// Token: 0x0600010C RID: 268 RVA: 0x00002D98 File Offset: 0x00000F98
		...
		// Token: 0x0600010E RID: 270 RVA: 0x00002DB8 File Offset: 0x00000FB8
		...
		// Token: 0x06000110 RID: 272 RVA: 0x00002DCB File Offset: 0x00000FCB
		...
		// Token: 0x06000111 RID: 273 RVA: 0x00002DDD File Offset: 0x00000FDD
		...
		// Token: 0x06000112 RID: 274 RVA: 0x00002DE7 File Offset: 0x00000FE7
		...
		// Token: 0x06000113 RID: 275 RVA: 0x00002E0D File Offset: 0x0000100D
		...
		// Token: 0x06000114 RID: 276 RVA: 0x00002E2F File Offset: 0x0000102F
		...
		// Token: 0x06000115 RID: 277 RVA: 0x00002E4D File Offset: 0x0000104D
		...
		// Token: 0x06000116 RID: 278 RVA: 0x00002E68 File Offset: 0x00001068
		...
		// Token: 0x06000118 RID: 280 RVA: 0x00002E80 File Offset: 0x00001080
		...
		// Token: 0x06000119 RID: 281 RVA: 0x00002E98 File Offset: 0x00001098
		...
		// Token: 0x0600011B RID: 283 RVA: 0x00002EA4 File Offset: 0x000010A4
		public T GetBehaviour<T>() where T : StateMachineBehaviour
		{
			return this.GetBehaviour(typeof(T)) as T;
		}

		// Token: 0x0600011C RID: 284 RVA: 0x00002ED0 File Offset: 0x000010D0
		...
		// Token: 0x0600011D RID: 285 RVA: 0x00002F1C File Offset: 0x0000111C
		...
		// Token: 0x06000129 RID: 297 RVA: 0x00002F70 File Offset: 0x00001170
		...
		// Token: 0x0600012A RID: 298 RVA: 0x00002F90 File Offset: 0x00001190
		...
		// Token: 0x0600012C RID: 300 RVA: 0x00002FB0 File Offset: 0x000011B0
		...
		// Token: 0x0600012E RID: 302 RVA: 0x00002FD0 File Offset: 0x000011D0
		public int GetCurrentAnimatorClipInfoCount(int layerIndex)
		{
			return this.GetAnimatorClipInfoCount(layerIndex, true);
		}

		// Token: 0x0600012F RID: 303 RVA: 0x00002FEC File Offset: 0x000011EC
		...
		// Token: 0x06000132 RID: 306 RVA: 0x00003008 File Offset: 0x00001208
		...
		// Token: 0x06000134 RID: 308 RVA: 0x00003034 File Offset: 0x00001234
		...
		// Token: 0x06000138 RID: 312 RVA: 0x00003060 File Offset: 0x00001260
		...
		// (get) Token: 0x0600013C RID: 316 RVA: 0x000030B4 File Offset: 0x000012B4
		...
		// Token: 0x0600013D RID: 317 RVA: 0x000030CA File Offset: 0x000012CA
		...
		// Token: 0x0600013E RID: 318 RVA: 0x000030DD File Offset: 0x000012DD
		...
		// Token: 0x0600013F RID: 319 RVA: 0x000030F3 File Offset: 0x000012F3
		...
		// Token: 0x06000140 RID: 320 RVA: 0x00003106 File Offset: 0x00001306
		...
		// Token: 0x06000145 RID: 325 RVA: 0x00003111 File Offset: 0x00001311
		...
		// Token: 0x06000146 RID: 326 RVA: 0x00003120 File Offset: 0x00001320
		...
		// Token: 0x06000147 RID: 327 RVA: 0x00003150 File Offset: 0x00001350
		...
		// Token: 0x06000148 RID: 328 RVA: 0x0000317C File Offset: 0x0000137C
		...
		// Token: 0x06000149 RID: 329 RVA: 0x000031A2 File Offset: 0x000013A2
		...
		// Token: 0x0600014A RID: 330 RVA: 0x000031B8 File Offset: 0x000013B8
		...
		// Token: 0x0600014B RID: 331 RVA: 0x000031DC File Offset: 0x000013DC
		...
		// Token: 0x0600014C RID: 332 RVA: 0x00003204 File Offset: 0x00001404
		...
		// Token: 0x0600014F RID: 335 RVA: 0x0000322C File Offset: 0x0000142C
		...
		// Token: 0x06000150 RID: 336 RVA: 0x00003250 File Offset: 0x00001450
		...
		// Token: 0x06000151 RID: 337 RVA: 0x00003278 File Offset: 0x00001478
		...
		// Token: 0x06000152 RID: 338 RVA: 0x000032A0 File Offset: 0x000014A0
		...
		// Token: 0x06000154 RID: 340 RVA: 0x000032B8 File Offset: 0x000014B8
		...
		// Token: 0x06000155 RID: 341 RVA: 0x000032DC File Offset: 0x000014DC
		...
		// Token: 0x06000156 RID: 342 RVA: 0x00003304 File Offset: 0x00001504
		...
		// Token: 0x06000157 RID: 343 RVA: 0x0000332C File Offset: 0x0000152C
		...
		// Token: 0x06000158 RID: 344 RVA: 0x0000334C File Offset: 0x0000154C
		...
		// Token: 0x06000159 RID: 345 RVA: 0x0000336C File Offset: 0x0000156C
		...
		// Token: 0x0600015B RID: 347 RVA: 0x00003380 File Offset: 0x00001580
		...
		// Token: 0x0600015C RID: 348 RVA: 0x000033A0 File Offset: 0x000015A0
		...
		// Token: 0x0600015D RID: 349 RVA: 0x000033C0 File Offset: 0x000015C0
		...
		// Token: 0x0600015E RID: 350 RVA: 0x000033E0 File Offset: 0x000015E0
		...
		// Token: 0x0600015F RID: 351 RVA: 0x00003400 File Offset: 0x00001600
		...
		// Token: 0x06000161 RID: 353 RVA: 0x00003414 File Offset: 0x00001614
		...
		// Token: 0x06000162 RID: 354 RVA: 0x00003434 File Offset: 0x00001634
		...
		// (get) Token: 0x06000164 RID: 356 RVA: 0x00003454 File Offset: 0x00001654
		...
		// (get) Token: 0x06000165 RID: 357 RVA: 0x0000346C File Offset: 0x0000166C
		...
		// Token: 0x06000166 RID: 358 RVA: 0x00003484 File Offset: 0x00001684
		[EditorBrowsable(1)]
		...
		// Token: 0x06000169 RID: 361 RVA: 0x00003498 File Offset: 0x00001698
		...
		// (get) Token: 0x06000173 RID: 371 RVA: 0x000034E0 File Offset: 0x000016E0
		// (set) Token: 0x06000174 RID: 372 RVA: 0x00002059 File Offset: 0x00000259
		...
		// (get) Token: 0x06000176 RID: 374 RVA: 0x000034F8 File Offset: 0x000016F8
		...
		// (get) Token: 0x06000183 RID: 387 RVA: 0x00003510 File Offset: 0x00001710
		...
		// Token: 0x06000185 RID: 389 RVA: 0x00003534 File Offset: 0x00001734
		...
		// Token: 0x060001A4 RID: 420 RVA: 0x00003565 File Offset: 0x00001765
		public void Rebind()
		{
			this.Rebind(true);
		}
		...
		// Token: 0x060001A7 RID: 423 RVA: 0x00003570 File Offset: 0x00001770
		[NativeConditional("UNITY_EDITOR")]
		...
		// Token: 0x060001A9 RID: 425 RVA: 0x00003580 File Offset: 0x00001780
		[NativeConditional("UNITY_EDITOR")]
		...
		// Token: 0x060001AA RID: 426 RVA: 0x0000359C File Offset: 0x0000179C
		[NativeConditional("UNITY_EDITOR")]
		...
		// Token: 0x060001B3 RID: 435 RVA: 0x000035B8 File Offset: 0x000017B8
		...
		// Token: 0x060001B4 RID: 436 RVA: 0x000035D0 File Offset: 0x000017D0
		[Obsolete("GetVector is deprecated.")]
		...
		// Token: 0x060001B5 RID: 437 RVA: 0x00002059 File Offset: 0x00000259
		[Obsolete("SetVector is deprecated.")]
		public void SetVector(string name, Vector3 value)
		{
		}

		// Token: 0x060001B6 RID: 438 RVA: 0x00002059 File Offset: 0x00000259
		[Obsolete("SetVector is deprecated.")]
		public void SetVector(int id, Vector3 value)
		{
		}

		// Token: 0x060001B7 RID: 439 RVA: 0x000035E8 File Offset: 0x000017E8
		...
		// Token: 0x060001B8 RID: 440 RVA: 0x00003600 File Offset: 0x00001800
		[Obsolete("GetQuaternion is deprecated.")]
		...
		// Token: 0x060001B9 RID: 441 RVA: 0x00002059 File Offset: 0x00000259
		[Obsolete("SetQuaternion is deprecated.")]
		public void SetQuaternion(string name, Quaternion value)
		{
		}

		// Token: 0x060001BA RID: 442 RVA: 0x00002059 File Offset: 0x00000259
		[Obsolete("SetQuaternion is deprecated.")]
