...
namespace UnityEngine
{
	...
	public sealed class AnimationEvent
	{
		...
		// (get) Token: 0x0600006D RID: 109 RVA: 0x00002388 File Offset: 0x00000588
		// (set) Token: 0x0600006E RID: 110 RVA: 0x000023A0 File Offset: 0x000005A0
		...
		// (get) Token: 0x0600006F RID: 111 RVA: 0x000023AC File Offset: 0x000005AC
		...
		// (get) Token: 0x06000071 RID: 113 RVA: 0x000023C4 File Offset: 0x000005C4
		// (set) Token: 0x06000072 RID: 114 RVA: 0x000023DC File Offset: 0x000005DC
		...
		// (get) Token: 0x06000073 RID: 115 RVA: 0x000023E8 File Offset: 0x000005E8
		// (set) Token: 0x06000074 RID: 116 RVA: 0x00002400 File Offset: 0x00000600
		...
		// (get) Token: 0x06000075 RID: 117 RVA: 0x0000240C File Offset: 0x0000060C
		// (set) Token: 0x06000076 RID: 118 RVA: 0x00002424 File Offset: 0x00000624
		...
		// (get) Token: 0x06000077 RID: 119 RVA: 0x00002430 File Offset: 0x00000630
		// (set) Token: 0x06000078 RID: 120 RVA: 0x00002448 File Offset: 0x00000648
		...
		// (get) Token: 0x06000079 RID: 121 RVA: 0x00002454 File Offset: 0x00000654
		// (set) Token: 0x0600007A RID: 122 RVA: 0x0000246C File Offset: 0x0000066C
		public float time
		{
			get
			{
		...
		// (get) Token: 0x0600007B RID: 123 RVA: 0x00002478 File Offset: 0x00000678
		// (set) Token: 0x0600007C RID: 124 RVA: 0x00002490 File Offset: 0x00000690
		...
		// (get) Token: 0x0600007D RID: 125 RVA: 0x0000249C File Offset: 0x0000069C
		...
		// (get) Token: 0x0600007E RID: 126 RVA: 0x000024B8 File Offset: 0x000006B8
		...
		// (get) Token: 0x0600007F RID: 127 RVA: 0x000024D4 File Offset: 0x000006D4
		...
		// (get) Token: 0x06000080 RID: 128 RVA: 0x00002504 File Offset: 0x00000704
		...
		// Token: 0x06000082 RID: 130 RVA: 0x00002564 File Offset: 0x00000764
