...
namespace System.Security.Cryptography
{
	...
	public class SHA384Managed : SHA384
	{
		...
		// Token: 0x060047B5 RID: 18357 RVA: 0x000FFE6C File Offset: 0x000FE06C
		...
		// Token: 0x060047B6 RID: 18358 RVA: 0x000FFEC5 File Offset: 0x000FE0C5
		...
		// Token: 0x060047B7 RID: 18359 RVA: 0x000FFEF5 File Offset: 0x000FE0F5
		...
		// Token: 0x060047B8 RID: 18360 RVA: 0x000FFF00 File Offset: 0x000FE100
		[SecuritySafeCritical]
		...
		// Token: 0x060047B9 RID: 18361 RVA: 0x000FFF08 File Offset: 0x000FE108
		...
		// Token: 0x060047BA RID: 18362 RVA: 0x000FFFA8 File Offset: 0x000FE1A8
		[SecurityCritical]
		...
		// Token: 0x060047BB RID: 18363 RVA: 0x001000D4 File Offset: 0x000FE2D4
		[SecurityCritical]
		...
		// Token: 0x060047BC RID: 18364 RVA: 0x001001C8 File Offset: 0x000FE3C8
		[SecurityCritical]
		...
		// Token: 0x060047BD RID: 18365 RVA: 0x001004E5 File Offset: 0x000FE6E5
		private static ulong RotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x060047BE RID: 18366 RVA: 0x001004F7 File Offset: 0x000FE6F7
		private static ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ ((x ^ ulong.MaxValue) & z);
		}

		// Token: 0x060047BF RID: 18367 RVA: 0x000FFD5E File Offset: 0x000FDF5E
		private static ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x060047C0 RID: 18368 RVA: 0x00100503 File Offset: 0x000FE703
		private static ulong Sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 28) ^ SHA384Managed.RotateRight(x, 34) ^ SHA384Managed.RotateRight(x, 39);
		}

		// Token: 0x060047C1 RID: 18369 RVA: 0x0010051F File Offset: 0x000FE71F
		private static ulong Sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 14) ^ SHA384Managed.RotateRight(x, 18) ^ SHA384Managed.RotateRight(x, 41);
		}

		// Token: 0x060047C2 RID: 18370 RVA: 0x0010053B File Offset: 0x000FE73B
		private static ulong sigma_0(ulong x)
		{
			return SHA384Managed.RotateRight(x, 1) ^ SHA384Managed.RotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x060047C3 RID: 18371 RVA: 0x00100550 File Offset: 0x000FE750
		private static ulong sigma_1(ulong x)
		{
			return SHA384Managed.RotateRight(x, 19) ^ SHA384Managed.RotateRight(x, 61) ^ (x >> 6);
		}

		// Token: 0x060047C4 RID: 18372 RVA: 0x00100568 File Offset: 0x000FE768
		[SecurityCritical]
