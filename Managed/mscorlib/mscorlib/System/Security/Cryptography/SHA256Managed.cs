...
namespace System.Security.Cryptography
{
	...
	public class SHA256Managed : SHA256
	{
		...
		// Token: 0x060047A1 RID: 18337 RVA: 0x000FF708 File Offset: 0x000FD908
		...
		// Token: 0x060047A2 RID: 18338 RVA: 0x000FF75E File Offset: 0x000FD95E
		...
		// Token: 0x060047A3 RID: 18339 RVA: 0x000FF78E File Offset: 0x000FD98E
		...
		// Token: 0x060047A4 RID: 18340 RVA: 0x000FF799 File Offset: 0x000FD999
		protected override byte[] HashFinal()
		{
			return this._EndHash();
		}

		// Token: 0x060047A5 RID: 18341 RVA: 0x000FF7A4 File Offset: 0x000FD9A4
		...
		// Token: 0x060047A6 RID: 18342 RVA: 0x000FF824 File Offset: 0x000FDA24
		...
		// Token: 0x060047A7 RID: 18343 RVA: 0x000FF938 File Offset: 0x000FDB38
		...
		// Token: 0x060047A8 RID: 18344 RVA: 0x000FFA24 File Offset: 0x000FDC24
		[SecurityCritical]
		...
		// Token: 0x060047A9 RID: 18345 RVA: 0x000FFD41 File Offset: 0x000FDF41
		private static uint RotateRight(uint x, int n)
		{
			return (x >> n) | (x << 32 - n);
		}

		// Token: 0x060047AA RID: 18346 RVA: 0x000FFD53 File Offset: 0x000FDF53
		private static uint Ch(uint x, uint y, uint z)
		{
			return (x & y) ^ ((x ^ uint.MaxValue) & z);
		}

		// Token: 0x060047AB RID: 18347 RVA: 0x000FFD5E File Offset: 0x000FDF5E
		private static uint Maj(uint x, uint y, uint z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x060047AC RID: 18348 RVA: 0x000FFD6B File Offset: 0x000FDF6B
		private static uint sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 7) ^ SHA256Managed.RotateRight(x, 18) ^ (x >> 3);
		}

		// Token: 0x060047AD RID: 18349 RVA: 0x000FFD81 File Offset: 0x000FDF81
		private static uint sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 17) ^ SHA256Managed.RotateRight(x, 19) ^ (x >> 10);
		}

		// Token: 0x060047AE RID: 18350 RVA: 0x000FFD99 File Offset: 0x000FDF99
		private static uint Sigma_0(uint x)
		{
			return SHA256Managed.RotateRight(x, 2) ^ SHA256Managed.RotateRight(x, 13) ^ SHA256Managed.RotateRight(x, 22);
		}

		// Token: 0x060047AF RID: 18351 RVA: 0x000FFDB4 File Offset: 0x000FDFB4
		private static uint Sigma_1(uint x)
		{
			return SHA256Managed.RotateRight(x, 6) ^ SHA256Managed.RotateRight(x, 11) ^ SHA256Managed.RotateRight(x, 25);
		}

		// Token: 0x060047B0 RID: 18352 RVA: 0x000FFDD0 File Offset: 0x000FDFD0
		[SecurityCritical]
