...
namespace System.Windows.Forms.RTF
{
	...
	{
		// Token: 0x06000171 RID: 369 RVA: 0x0000DE84 File Offset: 0x0000C084
		public static string Name(int index)
		{
			if (index < 0 || index >= StandardCharName.Names.Length)
			{
				return string.Empty;
			}
			return StandardCharName.Names[index];
		}

		// Token: 0x06000172 RID: 370 RVA: 0x0000DEA8 File Offset: 0x0000C0A8
		public static int ID(string name)
		{
			for (int i = 0; i < StandardCharName.Names.Length; i++)
			{
				if (name.Equals(StandardCharName.Names[i]))
				{
					return i;
				}
			}
