...
namespace UnityEngine.Rendering.PostProcessing
{
	...
	public sealed class PostProcessLayer : MonoBehaviour
	{
		...
		// (get) Token: 0x0600011C RID: 284 RVA: 0x0000A52F File Offset: 0x0000872F
		// (set) Token: 0x0600011D RID: 285 RVA: 0x0000A537 File Offset: 0x00008737
		public Dictionary<PostProcessEvent, List<PostProcessLayer.SerializedBundleRef>> sortedBundles { get; private set; }

		// Token: 0x1700000C RID: 12
		// (get) Token: 0x0600011E RID: 286 RVA: 0x0000A540 File Offset: 0x00008740
		// (set) Token: 0x0600011F RID: 287 RVA: 0x0000A548 File Offset: 0x00008748
		public DepthTextureMode cameraDepthFlags { get; private set; }

		// Token: 0x1700000D RID: 13
		// (get) Token: 0x06000120 RID: 288 RVA: 0x0000A551 File Offset: 0x00008751
		// (set) Token: 0x06000121 RID: 289 RVA: 0x0000A559 File Offset: 0x00008759
		public bool haveBundlesBeenInited { get; private set; }

		// Token: 0x06000122 RID: 290 RVA: 0x0000A564 File Offset: 0x00008764
		...
		// Token: 0x06000123 RID: 291 RVA: 0x0000A5C0 File Offset: 0x000087C0
		...
		// Token: 0x06000124 RID: 292 RVA: 0x0000A687 File Offset: 0x00008887
		...
		// Token: 0x06000125 RID: 293 RVA: 0x0000A6BC File Offset: 0x000088BC
		[ImageEffectUsesCommandBuffer]
		private void OnRenderImage(RenderTexture src, RenderTexture dst)
		{
			if (this.finalBlitToCameraTarget && this.DynamicResolutionAllowsFinalBlitToCameraTarget())
			{
		...
		// Token: 0x06000126 RID: 294 RVA: 0x0000A6DC File Offset: 0x000088DC
		...
		// Token: 0x06000127 RID: 295 RVA: 0x0000A73C File Offset: 0x0000893C
		...
		// Token: 0x06000128 RID: 296 RVA: 0x0000A854 File Offset: 0x00008A54
		...
		// Token: 0x06000129 RID: 297 RVA: 0x0000A9C4 File Offset: 0x00008BC4
		...
		// Token: 0x0600012A RID: 298 RVA: 0x0000AAE4 File Offset: 0x00008CE4
		private void Reset()
		{
			this.volumeTrigger = base.transform;
		}

		// Token: 0x0600012B RID: 299 RVA: 0x0000AAF4 File Offset: 0x00008CF4
		...
		// Token: 0x0600012C RID: 300 RVA: 0x0000AC0C File Offset: 0x00008E0C
		...
		// Token: 0x0600012D RID: 301 RVA: 0x00004DDA File Offset: 0x00002FDA
		private static bool RequiresInitialBlit(Camera camera, PostProcessRenderContext context)
		{
			return true;
		}

		// Token: 0x0600012E RID: 302 RVA: 0x0000AC2C File Offset: 0x00008E2C
		...
		// Token: 0x0600012F RID: 303 RVA: 0x0000AC9C File Offset: 0x00008E9C
		private void BuildCommandBuffers()
		{
			PostProcessRenderContext currentContext = this.m_CurrentContext;
			RenderTextureFormat renderTextureFormat = (this.m_Camera.allowHDR ? RuntimeUtilities.defaultHDRRenderTextureFormat : RenderTextureFormat.Default);
			...
			if (PostProcessLayer.RequiresInitialBlit(this.m_Camera, currentContext) || flag8)
			{
				num4 = this.m_TargetPool.Get();
				currentContext.GetScreenSpaceTemporaryRT(this.m_LegacyCmdBuffer, num4, 0, renderTextureFormat, RenderTextureReadWrite.sRGB, FilterMode.Bilinear, 0, 0);
			...
			currentContext.destination = renderTargetIdentifier;
			if (this.finalBlitToCameraTarget && !RuntimeUtilities.scriptableRenderPipelineActive && this.DynamicResolutionAllowsFinalBlitToCameraTarget())
			{
		...
		// Token: 0x06000130 RID: 304 RVA: 0x0000B048 File Offset: 0x00009248
		...
		// Token: 0x06000131 RID: 305 RVA: 0x0000B0BD File Offset: 0x000092BD
		public PostProcessBundle GetBundle<T>() where T : PostProcessEffectSettings
		{
			return this.GetBundle(typeof(T));
		}

		// Token: 0x06000132 RID: 306 RVA: 0x0000B0CF File Offset: 0x000092CF
		public PostProcessBundle GetBundle(Type settingsType)
		{
			return this.m_Bundles[settingsType];
		}

		// Token: 0x06000133 RID: 307 RVA: 0x0000B0DD File Offset: 0x000092DD
		public T GetSettings<T>() where T : PostProcessEffectSettings
		{
			return this.GetBundle<T>().CastSettings<T>();
		}

		// Token: 0x06000134 RID: 308 RVA: 0x0000B0EA File Offset: 0x000092EA
		...
		// Token: 0x06000135 RID: 309 RVA: 0x0000B118 File Offset: 0x00009318
		...
		// Token: 0x06000136 RID: 310 RVA: 0x0000B1C4 File Offset: 0x000093C4
		...
		// Token: 0x06000137 RID: 311 RVA: 0x0000B2A4 File Offset: 0x000094A4
		...
		// Token: 0x06000138 RID: 312 RVA: 0x0000B308 File Offset: 0x00009508
		public bool HasOpaqueOnlyEffects(PostProcessRenderContext context)
		{
			return this.HasActiveEffects(PostProcessEvent.BeforeTransparent, context);
		}

		// Token: 0x06000139 RID: 313 RVA: 0x0000B314 File Offset: 0x00009514
		...
		// Token: 0x0600013A RID: 314 RVA: 0x0000B3A4 File Offset: 0x000095A4
		private void SetupContext(PostProcessRenderContext context)
		{
			if (this.m_OldResources != this.m_Resources)
			{
		...
		// Token: 0x0600013B RID: 315 RVA: 0x0000B47C File Offset: 0x0000967C
		...
		// Token: 0x0600013C RID: 316 RVA: 0x0000B4DC File Offset: 0x000096DC
		...
		// Token: 0x0600013D RID: 317 RVA: 0x0000B52C File Offset: 0x0000972C
		...
		// Token: 0x0600013E RID: 318 RVA: 0x0000B8D4 File Offset: 0x00009AD4
		...
		// Token: 0x0600013F RID: 319 RVA: 0x0000B950 File Offset: 0x00009B50
		...
		// Token: 0x06000140 RID: 320 RVA: 0x0000BAFE File Offset: 0x00009CFE
		...
		// Token: 0x06000141 RID: 321 RVA: 0x0000BB3C File Offset: 0x00009D3C
		...
		// Token: 0x06000142 RID: 322 RVA: 0x0000BB90 File Offset: 0x00009D90
		...
		// Token: 0x06000143 RID: 323 RVA: 0x0000BE1C File Offset: 0x0000A01C
		...
		// Token: 0x06000144 RID: 324 RVA: 0x0000C0E0 File Offset: 0x0000A2E0
		...
		// Token: 0x06000145 RID: 325 RVA: 0x0000C184 File Offset: 0x0000A384
