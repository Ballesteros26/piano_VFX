...
namespace UnityEngine
{
	...
	internal static class RemoteConfigSettingsHelper
	{
		...
		internal static T[] GetArrayEntriesType<T>(IntPtr a, long size, Func<IntPtr, long, T> f)
		{
			...
			{
				array[(int)(checked((IntPtr)num))] = f.Invoke(a, num);
			}
			return array;
		}
		...
		// Token: 0x06000060 RID: 96 RVA: 0x000028EC File Offset: 0x00000AEC
		...
		// Token: 0x06000061 RID: 97 RVA: 0x000029E4 File Offset: 0x00000BE4
