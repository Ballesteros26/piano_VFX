...
namespace System
{
	...
	{
		// Token: 0x06000777 RID: 1911 RVA: 0x000020EB File Offset: 0x000002EB
		private DomainNameHelper()
		{
		}

		// Token: 0x06000778 RID: 1912 RVA: 0x00025000 File Offset: 0x00023200
		...
		// Token: 0x06000779 RID: 1913 RVA: 0x0002508C File Offset: 0x0002328C
		...
		// Token: 0x0600077A RID: 1914 RVA: 0x0002513C File Offset: 0x0002333C
		...
		// Token: 0x0600077B RID: 1915 RVA: 0x00025248 File Offset: 0x00023448
		...
		// Token: 0x0600077C RID: 1916 RVA: 0x0002527C File Offset: 0x0002347C
		...
		// Token: 0x0600077D RID: 1917 RVA: 0x00025390 File Offset: 0x00023590
		...
		// Token: 0x0600077E RID: 1918 RVA: 0x00025424 File Offset: 0x00023624
		private static bool IsIdnAce(string input, int index)
		{
			return input[index] == 'x' && input[index + 1] == 'n' && input[index + 2] == '-' && input[index + 3] == '-';
		}

		// Token: 0x0600077F RID: 1919 RVA: 0x0002545B File Offset: 0x0002365B
		private unsafe static bool IsIdnAce(char* input, int index)
		{
			return input[index] == 'x' && input[index + 1] == 'n' && input[index + 2] == '-' && input[index + 3] == '-';
		}

		// Token: 0x06000780 RID: 1920 RVA: 0x00025494 File Offset: 0x00023694
		...
		// Token: 0x06000781 RID: 1921 RVA: 0x000254D4 File Offset: 0x000236D4
		...
		// Token: 0x06000782 RID: 1922 RVA: 0x0002568C File Offset: 0x0002388C
		...
		// Token: 0x06000783 RID: 1923 RVA: 0x000256B4 File Offset: 0x000238B4
