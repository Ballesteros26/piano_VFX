...
namespace UnityEngine.Networking
{
	...
	public class Utility
	{
		...
		// (get) Token: 0x060000E7 RID: 231 RVA: 0x00003CB8 File Offset: 0x00001EB8
		// (set) Token: 0x060000E8 RID: 232 RVA: 0x00003C85 File Offset: 0x00001E85
		...
		// Token: 0x060000EA RID: 234 RVA: 0x00003CCC File Offset: 0x00001ECC
		public static SourceID GetSourceID()
		{
			return (SourceID)((long)SystemInfo.deviceUniqueIdentifier.GetHashCode());
		}

		// Token: 0x060000EB RID: 235 RVA: 0x00003C85 File Offset: 0x00001E85
		[EditorBrowsable(1)]
		...
		// Token: 0x060000EC RID: 236 RVA: 0x00003CEC File Offset: 0x00001EEC
		[Obsolete("This function is unused and should not be referenced in code. Please sign in and setup your project in the editor instead.", true)]
		[EditorBrowsable(1)]
		...
		// Token: 0x060000ED RID: 237 RVA: 0x00003D00 File Offset: 0x00001F00
		...
		// Token: 0x060000EE RID: 238 RVA: 0x00003D38 File Offset: 0x00001F38
		public static NetworkAccessToken GetAccessTokenForNetwork(NetworkID netId)
		{
			NetworkAccessToken networkAccessToken;
			bool flag = !Utility.s_dictTokens.TryGetValue(netId, ref networkAccessToken);
			if (flag)
			{
