...
namespace UnityEngine.Networking
{
	...
	{
		// Token: 0x0600007B RID: 123 RVA: 0x00002B08 File Offset: 0x00000D08
		...
		// Token: 0x0600007C RID: 124 RVA: 0x00002C14 File Offset: 0x00000E14
		public ConnectionConfig(ConnectionConfig config)
		{
			...
			foreach (List<byte> list in config.m_SharedOrderChannels)
			{
				this.m_SharedOrderChannels.Add(list);
			}
		}

		// Token: 0x0600007D RID: 125 RVA: 0x00002E58 File Offset: 0x00001058
		...
		// (get) Token: 0x0600007E RID: 126 RVA: 0x00002EE8 File Offset: 0x000010E8
		// (set) Token: 0x0600007F RID: 127 RVA: 0x00002F00 File Offset: 0x00001100
		...
		// (get) Token: 0x06000080 RID: 128 RVA: 0x00002F0C File Offset: 0x0000110C
		// (set) Token: 0x06000081 RID: 129 RVA: 0x00002F24 File Offset: 0x00001124
		...
		// (get) Token: 0x06000082 RID: 130 RVA: 0x00002F30 File Offset: 0x00001130
		// (set) Token: 0x06000083 RID: 131 RVA: 0x00002F48 File Offset: 0x00001148
		...
		// (get) Token: 0x06000084 RID: 132 RVA: 0x00002F54 File Offset: 0x00001154
		// (set) Token: 0x06000085 RID: 133 RVA: 0x00002F6C File Offset: 0x0000116C
		...
		// (get) Token: 0x06000086 RID: 134 RVA: 0x00002F78 File Offset: 0x00001178
		// (set) Token: 0x06000087 RID: 135 RVA: 0x00002F90 File Offset: 0x00001190
		...
		// (get) Token: 0x06000088 RID: 136 RVA: 0x00002F9C File Offset: 0x0000119C
		// (set) Token: 0x06000089 RID: 137 RVA: 0x00002FB4 File Offset: 0x000011B4
		...
		// (get) Token: 0x0600008A RID: 138 RVA: 0x00002FDC File Offset: 0x000011DC
		// (set) Token: 0x0600008B RID: 139 RVA: 0x00002FF4 File Offset: 0x000011F4
		...
		// (get) Token: 0x0600008C RID: 140 RVA: 0x00003000 File Offset: 0x00001200
		// (set) Token: 0x0600008D RID: 141 RVA: 0x00003018 File Offset: 0x00001218
		...
		// (get) Token: 0x0600008E RID: 142 RVA: 0x00003024 File Offset: 0x00001224
		// (set) Token: 0x0600008F RID: 143 RVA: 0x0000303C File Offset: 0x0000123C
		...
		// (get) Token: 0x06000090 RID: 144 RVA: 0x00003048 File Offset: 0x00001248
		// (set) Token: 0x06000091 RID: 145 RVA: 0x00003060 File Offset: 0x00001260
		...
		// (get) Token: 0x06000092 RID: 146 RVA: 0x0000306C File Offset: 0x0000126C
		// (set) Token: 0x06000093 RID: 147 RVA: 0x00003084 File Offset: 0x00001284
		...
		// (get) Token: 0x06000094 RID: 148 RVA: 0x00003090 File Offset: 0x00001290
		// (set) Token: 0x06000095 RID: 149 RVA: 0x000030A8 File Offset: 0x000012A8
		...
		// (get) Token: 0x06000096 RID: 150 RVA: 0x000030B4 File Offset: 0x000012B4
		// (set) Token: 0x06000097 RID: 151 RVA: 0x000030CC File Offset: 0x000012CC
		...
		// (get) Token: 0x06000098 RID: 152 RVA: 0x000030D8 File Offset: 0x000012D8
		// (set) Token: 0x06000099 RID: 153 RVA: 0x000030F0 File Offset: 0x000012F0
		...
		// (set) Token: 0x0600009B RID: 155 RVA: 0x00003114 File Offset: 0x00001314
		...
		// (get) Token: 0x0600009C RID: 156 RVA: 0x00003120 File Offset: 0x00001320
		// (set) Token: 0x0600009D RID: 157 RVA: 0x00003138 File Offset: 0x00001338
		...
		// (set) Token: 0x0600009F RID: 159 RVA: 0x0000315C File Offset: 0x0000135C
		...
		// (get) Token: 0x060000A0 RID: 160 RVA: 0x00003168 File Offset: 0x00001368
		// (set) Token: 0x060000A1 RID: 161 RVA: 0x00003180 File Offset: 0x00001380
		...
		// (get) Token: 0x060000A2 RID: 162 RVA: 0x0000318C File Offset: 0x0000138C
		// (set) Token: 0x060000A3 RID: 163 RVA: 0x000031AC File Offset: 0x000013AC
		...
		// (get) Token: 0x060000A4 RID: 164 RVA: 0x000031E8 File Offset: 0x000013E8
		// (set) Token: 0x060000A5 RID: 165 RVA: 0x00003200 File Offset: 0x00001400
		...
		// (get) Token: 0x060000A6 RID: 166 RVA: 0x00003238 File Offset: 0x00001438
		// (set) Token: 0x060000A7 RID: 167 RVA: 0x00003250 File Offset: 0x00001450
		...
		// (get) Token: 0x060000A8 RID: 168 RVA: 0x0000325C File Offset: 0x0000145C
		// (set) Token: 0x060000A9 RID: 169 RVA: 0x00003274 File Offset: 0x00001474
		...
		// (get) Token: 0x060000AA RID: 170 RVA: 0x00003280 File Offset: 0x00001480
		// (set) Token: 0x060000AB RID: 171 RVA: 0x00003298 File Offset: 0x00001498
		...
		// (get) Token: 0x060000AC RID: 172 RVA: 0x000032A4 File Offset: 0x000014A4
		// (set) Token: 0x060000AD RID: 173 RVA: 0x000032BC File Offset: 0x000014BC
		...
		// (get) Token: 0x060000AE RID: 174 RVA: 0x000032C8 File Offset: 0x000014C8
		// (set) Token: 0x060000AF RID: 175 RVA: 0x000032E0 File Offset: 0x000014E0
		...
		// (get) Token: 0x060000B0 RID: 176 RVA: 0x000032EC File Offset: 0x000014EC
		// (set) Token: 0x060000B1 RID: 177 RVA: 0x00003304 File Offset: 0x00001504
		...
		// (get) Token: 0x060000B2 RID: 178 RVA: 0x00003310 File Offset: 0x00001510
		// (set) Token: 0x060000B3 RID: 179 RVA: 0x00003328 File Offset: 0x00001528
		...
		// (get) Token: 0x060000B4 RID: 180 RVA: 0x00003334 File Offset: 0x00001534
		...
		// (get) Token: 0x060000B5 RID: 181 RVA: 0x00003354 File Offset: 0x00001554
		...
		// Token: 0x060000B6 RID: 182 RVA: 0x00003374 File Offset: 0x00001574
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x000033FC File Offset: 0x000015FC
		public void MakeChannelsSharedOrder(List<byte> channelIndices)
		{
			...
			{
				byte b4 = channelIndices[(int)b3];
				this.m_Channels[(int)b4].m_BelongsSharedOrderChannel = true;
				b3 += 1;
			}
			List<byte> list = new List<byte>(channelIndices);
			this.m_SharedOrderChannels.Add(list);
		}

		// Token: 0x060000B8 RID: 184 RVA: 0x00003548 File Offset: 0x00001748
		...
		// Token: 0x060000B9 RID: 185 RVA: 0x0000358C File Offset: 0x0000178C
		...
		// (get) Token: 0x060000BA RID: 186 RVA: 0x000035D0 File Offset: 0x000017D0
