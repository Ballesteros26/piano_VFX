...
namespace UnityEngine.Networking
{
	...
	public sealed class NetworkTransport
	{
		...
		public static int ConnectEndPoint(int hostId, EndPoint endPoint, int exceptionConnectionId, out byte error)
		{
			...
			if (flag3)
			{
				bool flag4 = endPoint.AddressFamily != 23;
				if (flag4)
				{
				...
				IntPtr intPtr;
				intPtr..ctor(BitConverter.ToInt64(array2, 0));
				...
				AddressFamily addressFamily = ((int)array3[1] << 8) + (int)array3[0];
				bool flag9 = addressFamily != 23;
				if (flag9)
				{
		...
		// Token: 0x06000068 RID: 104 RVA: 0x00002945 File Offset: 0x00000B45
		...
		// Token: 0x06000069 RID: 105 RVA: 0x00002952 File Offset: 0x00000B52
		...
		// Token: 0x0600006C RID: 108 RVA: 0x00002964 File Offset: 0x00000B64
		private static void CheckTopology(HostTopology topology)
		{
			...
			for (int i = 0; i < topology.SpecialConnectionConfigs.Count; i++)
			{
				...
				if (flag2)
				{
					throw new ArgumentOutOfRangeException(string.Concat(new object[] { "Special config ", i, ": packet size should be less than packet size defined in global config: ", maxPacketSize }));
				}
			}
		}
		...
		// Token: 0x0600006E RID: 110 RVA: 0x00002A0C File Offset: 0x00000C0C
		...
		// Token: 0x06000070 RID: 112 RVA: 0x00002A24 File Offset: 0x00000C24
		...
		// Token: 0x06000072 RID: 114 RVA: 0x00002A30 File Offset: 0x00000C30
