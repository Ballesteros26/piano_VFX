...
namespace UnityEngine.Networking
{
	...
	{
		// Token: 0x060000C9 RID: 201 RVA: 0x000038A4 File Offset: 0x00001AA4
		public GlobalConfig()
		{
		...
		// (get) Token: 0x060000CA RID: 202 RVA: 0x0000392C File Offset: 0x00001B2C
		// (set) Token: 0x060000CB RID: 203 RVA: 0x00003944 File Offset: 0x00001B44
		...
		// (get) Token: 0x060000CC RID: 204 RVA: 0x0000396C File Offset: 0x00001B6C
		// (set) Token: 0x060000CD RID: 205 RVA: 0x00003984 File Offset: 0x00001B84
		...
		// (get) Token: 0x060000CE RID: 206 RVA: 0x00003990 File Offset: 0x00001B90
		// (set) Token: 0x060000CF RID: 207 RVA: 0x000039A8 File Offset: 0x00001BA8
		...
		// (get) Token: 0x060000D0 RID: 208 RVA: 0x000039B4 File Offset: 0x00001BB4
		// (set) Token: 0x060000D1 RID: 209 RVA: 0x000039CC File Offset: 0x00001BCC
		...
		// (get) Token: 0x060000D2 RID: 210 RVA: 0x000039D8 File Offset: 0x00001BD8
		// (set) Token: 0x060000D3 RID: 211 RVA: 0x000039F0 File Offset: 0x00001BF0
		...
		// (get) Token: 0x060000D4 RID: 212 RVA: 0x000039FC File Offset: 0x00001BFC
		// (set) Token: 0x060000D5 RID: 213 RVA: 0x00003A14 File Offset: 0x00001C14
		public ushort MaxHosts
		{
			...
			set
			{
				...
				if (flag2)
				{
					throw new ArgumentOutOfRangeException("MaxHosts", "Maximum hosts number should be <= " + 128);
				}
		...
		// (get) Token: 0x060000D6 RID: 214 RVA: 0x00003A6C File Offset: 0x00001C6C
		// (set) Token: 0x060000D7 RID: 215 RVA: 0x00003A84 File Offset: 0x00001C84
		...
		// (get) Token: 0x060000D8 RID: 216 RVA: 0x00003A90 File Offset: 0x00001C90
		// (set) Token: 0x060000D9 RID: 217 RVA: 0x00003AA8 File Offset: 0x00001CA8
		...
		// (get) Token: 0x060000DA RID: 218 RVA: 0x00003AE8 File Offset: 0x00001CE8
		// (set) Token: 0x060000DB RID: 219 RVA: 0x00003B00 File Offset: 0x00001D00
		...
		// (get) Token: 0x060000DC RID: 220 RVA: 0x00003B50 File Offset: 0x00001D50
		// (set) Token: 0x060000DD RID: 221 RVA: 0x00003B68 File Offset: 0x00001D68
		...
		// (get) Token: 0x060000DE RID: 222 RVA: 0x00003BA8 File Offset: 0x00001DA8
		// (set) Token: 0x060000DF RID: 223 RVA: 0x00003BC0 File Offset: 0x00001DC0
		...
		// (get) Token: 0x060000E0 RID: 224 RVA: 0x00003C10 File Offset: 0x00001E10
		// (set) Token: 0x060000E1 RID: 225 RVA: 0x00003C28 File Offset: 0x00001E28
		...
		// (get) Token: 0x060000E2 RID: 226 RVA: 0x00003C34 File Offset: 0x00001E34
		// (set) Token: 0x060000E3 RID: 227 RVA: 0x00003C4C File Offset: 0x00001E4C
