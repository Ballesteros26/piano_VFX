...
namespace Mono.Security.Cryptography
{
	...
	{
		// Token: 0x060005D3 RID: 1491 RVA: 0x0001BB7B File Offset: 0x00019D7B
		...
		// Token: 0x060005D4 RID: 1492 RVA: 0x0001BBAF File Offset: 0x00019DAF
		private uint Ch(uint u, uint v, uint w)
		{
			return (u & v) ^ (~u & w);
		}

		// Token: 0x060005D5 RID: 1493 RVA: 0x0001BBB9 File Offset: 0x00019DB9
		private uint Maj(uint u, uint v, uint w)
		{
			return (u & v) ^ (u & w) ^ (v & w);
		}

		// Token: 0x060005D6 RID: 1494 RVA: 0x0001BBC6 File Offset: 0x00019DC6
		private uint Ro0(uint x)
		{
			return ((x >> 7) | (x << 25)) ^ ((x >> 18) | (x << 14)) ^ (x >> 3);
		}

		// Token: 0x060005D7 RID: 1495 RVA: 0x0001BBDE File Offset: 0x00019DDE
		private uint Ro1(uint x)
		{
			return ((x >> 17) | (x << 15)) ^ ((x >> 19) | (x << 13)) ^ (x >> 10);
		}

		// Token: 0x060005D8 RID: 1496 RVA: 0x0001BBF8 File Offset: 0x00019DF8
		private uint Sig0(uint x)
		{
			return ((x >> 2) | (x << 30)) ^ ((x >> 13) | (x << 19)) ^ ((x >> 22) | (x << 10));
		}

		// Token: 0x060005D9 RID: 1497 RVA: 0x0001BC16 File Offset: 0x00019E16
		private uint Sig1(uint x)
		{
			return ((x >> 6) | (x << 26)) ^ ((x >> 11) | (x << 21)) ^ ((x >> 25) | (x << 7));
		}

		// Token: 0x060005DA RID: 1498 RVA: 0x0001BC34 File Offset: 0x00019E34
		...
		// Token: 0x060005DB RID: 1499 RVA: 0x0001BD00 File Offset: 0x00019F00
		...
		// Token: 0x060005DC RID: 1500 RVA: 0x0001BD64 File Offset: 0x00019F64
		...
		// Token: 0x060005DD RID: 1501 RVA: 0x0001BDE8 File Offset: 0x00019FE8
		...
		// Token: 0x060005DE RID: 1502 RVA: 0x0001C054 File Offset: 0x0001A254
		...
		// Token: 0x060005DF RID: 1503 RVA: 0x0001C0F0 File Offset: 0x0001A2F0
