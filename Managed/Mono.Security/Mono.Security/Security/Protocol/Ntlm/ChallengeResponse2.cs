...
namespace Mono.Security.Protocol.Ntlm
{
	...
	{
		// Token: 0x0600041F RID: 1055 RVA: 0x00015B68 File Offset: 0x00013D68
		...
		// Token: 0x06000420 RID: 1056 RVA: 0x00015C14 File Offset: 0x00013E14
		...
		// Token: 0x06000421 RID: 1057 RVA: 0x00015C6C File Offset: 0x00013E6C
		...
		// Token: 0x06000422 RID: 1058 RVA: 0x00015C88 File Offset: 0x00013E88
		...
		// Token: 0x06000423 RID: 1059 RVA: 0x00015D24 File Offset: 0x00013F24
		private static byte[] Compute_NTLMv2(Type2Message type2, string username, string password, string domain)
		{
			...
			long num = DateTime.Now.Ticks - 504911232000000000L;
			byte[] array4 = new byte[8];
			RandomNumberGenerator.Create().GetBytes(array4);
			byte[] array5 = new byte[28 + type2.TargetInfo.Length];
			array5[0] = 1;
			array5[1] = 1;
			Buffer.BlockCopy(BitConverterLE.GetBytes(num), 0, array5, 8, 8);
		...
		// Token: 0x06000424 RID: 1060 RVA: 0x00015EBC File Offset: 0x000140BC
		...
		// Token: 0x06000425 RID: 1061 RVA: 0x00015F68 File Offset: 0x00014168
		...
		// Token: 0x06000426 RID: 1062 RVA: 0x00015FE8 File Offset: 0x000141E8
		...
		// Token: 0x06000427 RID: 1063 RVA: 0x0001607C File Offset: 0x0001427C
		private static byte[] PasswordToKey(string password, int position)
		{
			...
			byte[] array2 = ChallengeResponse2.PrepareDESKey(array, 0);
			Array.Clear(array, 0, array.Length);
			return array2;
		}
