...
namespace System.Web.Util
{
	...
	public class HttpEncoder
	{
		...
		// (get) Token: 0x06000E81 RID: 3713 RVA: 0x00027A10 File Offset: 0x00025C10
		...
		// (get) Token: 0x06000E82 RID: 3714 RVA: 0x00027A5C File Offset: 0x00025C5C
		// (set) Token: 0x06000E83 RID: 3715 RVA: 0x00027A79 File Offset: 0x00025C79
		...
		// (get) Token: 0x06000E84 RID: 3716 RVA: 0x00027A8F File Offset: 0x00025C8F
		...
		// Token: 0x06000E87 RID: 3719 RVA: 0x00027AF2 File Offset: 0x00025CF2
		...
		// Token: 0x06000E88 RID: 3720 RVA: 0x00027B1F File Offset: 0x00025D1F
		...
		// Token: 0x06000E89 RID: 3721 RVA: 0x00027B38 File Offset: 0x00025D38
		...
		// Token: 0x06000E8A RID: 3722 RVA: 0x00027B91 File Offset: 0x00025D91
		...
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="output" /> is null. </exception>
		// Token: 0x06000E8B RID: 3723 RVA: 0x00027BB6 File Offset: 0x00025DB6
		...
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="output" /> is null. </exception>
		// Token: 0x06000E8C RID: 3724 RVA: 0x00027BD2 File Offset: 0x00025DD2
		...
		// Token: 0x06000E8D RID: 3725 RVA: 0x00027BEE File Offset: 0x00025DEE
		protected internal virtual byte[] UrlEncode(byte[] bytes, int offset, int count)
		{
			return HttpEncoder.UrlEncodeToBytes(bytes, offset, count);
		}

		// Token: 0x06000E8E RID: 3726 RVA: 0x00027BF8 File Offset: 0x00025DF8
		private static HttpEncoder GetCustomEncoderFromConfig()
		{
			...
			{
				return HttpEncoder.Default;
			}
			Type type = Type.GetType(encoderType, false);
			if (type == null)
			{
				throw new ConfigurationErrorsException(string.Format("Could not load type '{0}'.", encoderType));
			}
			if (!typeof(HttpEncoder).IsAssignableFrom(type))
			{
				throw new ConfigurationErrorsException(string.Format("'{0}' is not allowed here because it does not extend class 'System.Web.Util.HttpEncoder'.", encoderType));
			}
			return Activator.CreateInstance(type, false) as HttpEncoder;
		}

		/// <summary>Encodes a subsection of a URL.</summary>
		/// <returns>A URL-encoded string. </returns>
		/// <param name="value">The string to encode.</param>
		// Token: 0x06000E8F RID: 3727 RVA: 0x00027C78 File Offset: 0x00025E78
		...
		// Token: 0x06000E90 RID: 3728 RVA: 0x00027CC8 File Offset: 0x00025EC8
		...
		// Token: 0x06000E91 RID: 3729 RVA: 0x00027D40 File Offset: 0x00025F40
		...
		// Token: 0x06000E92 RID: 3730 RVA: 0x00027EDC File Offset: 0x000260DC
		...
		// Token: 0x06000E93 RID: 3731 RVA: 0x00027FC4 File Offset: 0x000261C4
		...
		// Token: 0x06000E94 RID: 3732 RVA: 0x000282E1 File Offset: 0x000264E1
		internal static bool NotEncoded(char c)
		{
			return c == '!' || c == '(' || c == ')' || c == '*' || c == '-' || c == '.' || c == '_';
		}

		// Token: 0x06000E95 RID: 3733 RVA: 0x00028308 File Offset: 0x00026508
		...
		// Token: 0x06000E96 RID: 3734 RVA: 0x00028420 File Offset: 0x00026620
		...
		// Token: 0x06000E97 RID: 3735 RVA: 0x000284B0 File Offset: 0x000266B0
		...
		/// <param name="value">The string to encode.</param>
		// Token: 0x06000E98 RID: 3736 RVA: 0x0000E80B File Offset: 0x0000CA0B
