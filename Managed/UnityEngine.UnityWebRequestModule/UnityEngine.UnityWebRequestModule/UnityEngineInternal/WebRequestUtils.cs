		...
		internal static string MakeUriString(Uri targetUri, string targetUrl, bool prependProtocol)
		{
			...
			if (isFile)
			{
				...
				else
				{
					...
					bool flag3 = text2.Length > 0 && text2.get_Chars(0) != '/';
					if (flag3)
					{
						text2 = "/" + text2;
					}
			...
			else
			{
				...
				bool flag4 = !prependProtocol && targetUrl.Length >= scheme.Length + 2 && targetUrl.get_Chars(scheme.Length + 1) != '/';
				if (flag4)
				{
					...
					if (flag5)
					{
						...
						bool flag7 = text3.StartsWith("file:/") && text3.Length > 6 && text3.get_Chars(6) != '/';
						if (flag7)
						{
