...
namespace UnityEngine.Networking
{
	...
	public class MultipartFormFileSection : IMultipartFormSection
	{
		...
		// Token: 0x0600003F RID: 63 RVA: 0x000033E2 File Offset: 0x000015E2
		public MultipartFormFileSection(string fileName, byte[] data)
			: this(null, data, fileName, null)
		{
		}

		// Token: 0x06000040 RID: 64 RVA: 0x000033F0 File Offset: 0x000015F0
		...
		// Token: 0x06000041 RID: 65 RVA: 0x00003482 File Offset: 0x00001682
		public MultipartFormFileSection(string data, Encoding dataEncoding, string fileName)
			: this(null, data, dataEncoding, fileName)
		{
		}

		// Token: 0x06000042 RID: 66 RVA: 0x00003490 File Offset: 0x00001690
		...
		// (get) Token: 0x06000043 RID: 67 RVA: 0x000034A0 File Offset: 0x000016A0
		...
		// (get) Token: 0x06000044 RID: 68 RVA: 0x000034B8 File Offset: 0x000016B8
		...
		// (get) Token: 0x06000046 RID: 70 RVA: 0x000034E8 File Offset: 0x000016E8
